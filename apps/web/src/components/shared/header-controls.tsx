...
/*
 * Social links for the utility tier. Brand marks are official single-path logos
 * (simple-icons), rendered monochrome. Per product: replace the hrefs with the real
 * profiles and swap platforms as needed - names are proper nouns and stay hardcoded.
 */
...
/**
 * Icon + label social links for the utility tier. Labels collapse to icons below md;
 * below sm the links hide entirely - the phone-width utility tier keeps only Support
